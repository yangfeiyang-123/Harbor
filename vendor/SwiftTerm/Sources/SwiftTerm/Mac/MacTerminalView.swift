...
open class TerminalView: NSView, NSTextInputClient, NSUserInterfaceValidations, TerminalDelegate {
    ...
    open func linefeed(source: Terminal) {
        // Manual selections must survive streaming output, including Shift-drag
        // selections in mouse-aware programs. Buffer scrolling and replacement
        // already adjust or invalidate selections when their text disappears.
    }
    ...
    //
    // Harbor exposes the native focus hook so split panes can track the active PTY.
